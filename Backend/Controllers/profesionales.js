...
const obtenerNombreIDImagenProfesionales = (req,res) =>{
    const query = `select nombre_profesional, apellido_profesional, imagen_profesional, profesional_id, descripcion_profesional from Profesionales;`
...
module.exports = {
    ...
    editarProfesional,
    eliminarProfesional,
    obtenerNombreIDImagenProfesionales
};
